...
controllerAs:"ctrl"}).when("/info",{templateUrl:"../partials/info.html"}).when("/cart_mobile",{templateUrl:"../partials/cart_mobile.html",controller:"CartController",controllerAs:"cc"}).when("/login_mobile",{templateUrl:"../partials/login_mobile.html",controller:"LoginController",controllerAs:"c"}).when("/registration",{templateUrl:"../partials/registration.html",controller:"RegistrationCtrl",controllerAs:"ctrl"}).when("/password_recovery",{templateUrl:"../partials/password_recovery.html",controller:"LoginController",
controllerAs:"c"}).when("/me",{templateUrl:"../partials/me.html",controller:"MeController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/login",{templateUrl:"../partials/login.html",controller:"LoginController",controllerAs:"c"}).when("/confirm",{templateUrl:"../partials/confirm.html",controller:"ConfirmController",controllerAs:"ctrl"}).when("/reset",{templateUrl:"../partials/reset.html",controller:"ResetController",controllerAs:"ctrl"}).when("/admin",{templateUrl:"../partials/admin/dashboard.html",
controller:"AdminDashboardController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/films",{templateUrl:"../partials/admin/films.html",controller:"AdminFilmsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/films/new",{templateUrl:"../partials/admin/new_film.html",controller:"AdminFilmsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/films/:fid",{templateUrl:"../partials/admin/edit_film.html",controller:"AdminFilmsEditController",
controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/plays",{templateUrl:"../partials/admin/plays.html",controller:"AdminPlaysController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/plays/new",{templateUrl:"../partials/admin/new_play.html",controller:"AdminNewPlaysController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/plays/:pid",{templateUrl:"../partials/admin/edit_play.html",controller:"AdminPlaysEditController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/prices",
{templateUrl:"../partials/admin/prices.html",controller:"AdminPricesController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/rooms",{templateUrl:"../partials/admin/rooms.html",controller:"AdminRoomsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/rooms/new_room",{templateUrl:"../partials/admin/new_room.html",controller:"AdminNewRoomController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/rooms/edit_room/:rid",{templateUrl:"../partials/admin/edit_room.html",
controller:"AdminEditRoomController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/stats",{templateUrl:"../partials/admin/stats.html",controller:"AdminStatsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/users",{templateUrl:"../partials/admin/users.html",controller:"AdminUsersController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/users/new",{templateUrl:"../partials/admin/new_user.html",controller:"AdminUsersController",controllerAs:"ctrl",
resolve:{factory:checkRouting}}).when("/admin/users/:uid",{templateUrl:"../partials/admin/edit_user.html",controller:"AdminUsersEditController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/users/bookings/:uid",{templateUrl:"../partials/admin/user_bookings.html",controller:"AdminUserBookingsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/buy",{templateUrl:"../partials/buy_seats.html",controller:"BuySeatController",controllerAs:"ctrl"}).when("/buy_start_error",
{templateUrl:"../partials/buy_seats_error.html"}).when("/buy_last_step",{templateUrl:"../partials/buy_summary.html",controller:"BuySummaryController",controllerAs:"ctrl"}).when("/buy_complete",{templateUrl:"../partials/buy_complete.html",controller:"BuyCompleteController",controllerAs:"ctrl"}).when("/error",{templateUrl:"../partials/error.html"}).when("/popcorn",{templateUrl:"../partials/popcorn.html"}).otherwise({redirectTo:"/error"})}]).config(["uiGmapGoogleMapApiProvider",function(a){a.configure({v:"3.17",
libraries:"weather,geometry,visualization"})}]).directive("loading",function(){return{restrict:"E",templateUrl:"../partials/directives/loading.html",scope:{loading:"=loading"}}}).directive("onDropdownRepeat",function(){return function(a,c,e){a.$last&&a.$emit("dropdownRepeatEnd",c,e)}}).directive("onCollapsibleRepeat",function(){return function(a,c,e){a.$last&&a.$emit("collapsibleRepeatEnd",c,e)}}).directive("onSelectRepeat",function(){return function(a,c,e){a.$last&&a.$emit("selectRepeatEnd",c,e)}}).directive("onTooltipRepeat",
function(){return function(a,c,e){a.$last&&a.$emit("tooltipRepeatEnd",c,e)}}).run(["$rootScope","$location","$anchorScroll","$q","Prices","StorageService","Auth","CompletePlays","$sce","BuyProcedure",function(a,c,e,b,f,d,g,h,t,n){a.$on("$routeChangeStart",function(a,b){void 0!=c.search().c&&"/confirm"!=c.path()&&c.path("/confirm");void 0!=c.search().r&&"/reset"!=c.path()&&c.path("/reset")});a.$on("$routeChangeSuccess",function(){e()});a.cloneObject=function(a){return JSON.parse(JSON.stringify(a))};
a.trustSrcTrailerUrl=function(a){void 0!=a&&(a=a.replace("watch?v=","embed/"));return t.trustAsResourceUrl(a)};a.updateTotal=function(){for(var b=a.total=0;b<a.cart.length;b++)for(var f=0;f<a.tickets.length;f++){for(var h=0,d=0;d<a.cart[b].tickets.length;d++)a.cart[b].tickets[d].type==a.tickets[f].type&&(h+=a.cart[b].tickets[d].number);a.total+=a.tickets[f].price*h}};a.user={};a.isUserLogged=!1;a.isUserLoggedPromise=g.me();a.loginError="";a.afterLogin="normal";(function(){a.isUserLoggedPromise.then(function(b){a.isUserLogged=
!0;a.user=b},function(b){a.isUserLogged=!1;a.user={}})})();a.loadPrices=function(){f.getList().then(function(b){a.tickets=b.data;a.updateTotal()})};a.tickets=[];a.loadPrices();a.loadPlaysByDate=function(){h.playsByDate().then(function(b){a.playsByDate=b},function(b){a.playsByDate=[];c.path("/error")})};a.loadPlaysByDate();a.cart=a.cart||[];a.total=a.total||0;(function(){a.cart=d.loadCart();null==a.cart&&(a.cart=[]);n.proceed(a.cart).success(function(){}).error(function(b,f){a.cart=409==f?b:[]})})();
a.$watch(function(){return a.cart},function(b){a.updateTotal();d.saveCart(b)},!0);a.cartLength=function(){return a.cart.length};a.buy={shared_obj:{},data_from_server:[],data_from_server_index:-1,data_to_server:{},complete_error:!0};a.buy.data_to_server.cart=[]}]);function checkRouting($rootScope,$location,Auth){if($rootScope.isUserLoggedPromise!=undefined){$rootScope.isUserLoggedPromise.then(function(data){if(data!=undefined){if(data.role!="admin"&&$location.path()!="/me"){$location.path("/error")}}},function(){$location.path("/login")})}else{Auth.me().then(function(){$rootScope.isUserLogged=true;$rootScope.user=data;if(data.role!="admin"&&$location.path()!="/me"){$location.path("/error")}},function(){$rootScope.isUserLogged=false;$rootScope.user={};$location.path("/login")})}}
...
["$routeParams","$scope","$location","$anchorScroll","Users","Auth",function(a,c,e,b,f,d){var g=this;this.bookings=[];this.uid=a.uid;this.currentTid=-1;this.status_msg="";this.intToChar=function(a){return String.fromCharCode("A".charCodeAt()+parseInt(a))};this.getBookings=function(){d.user_bookings(a.uid).success(function(a){g.bookings=a;for(a=0;a<g.bookings.length;a++){for(var b=g.bookings[a],d=0,c=0;c<b.tickets.length;c++)void 0!=b.tickets[c].price&&(d+=b.tickets[c].price);b.total=d}}).error(function(){})};
