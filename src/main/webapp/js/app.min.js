...
m.transform("s"+v/680+",1");q.attr({width:l,height:r,x:y,y:165});u.append(m);u.append(q);l=y;r=225;q=String.fromCharCode("A".charCodeAt()-1);for(m=v=0;m<h;m++){var p=A.clone();p.transform("t"+l+","+r);q="Z"==q?"A":String.fromCharCode(q.charCodeAt()+1);p.select("text").attr({text:q});u.append(p);l+=50;for(p=0;p<e;p++){var w=z.clone();w.transform("t"+l+","+r);w.attr({row:m.toString()});w.attr({col:p.toString()});c(w,a[m][p],b,f,d);0!=a[m][p]&&u.append(w);0==a[m][p]&&d&&u.append(w);l+=55}r+=55;l=y}l+=
50;for(m=0;m<e;m++)a=B.clone(),a.transform("t"+l+","+r),v++,a.select("text").attr({text:v}),u.append(a),l+=55;$(".tooltipped").tooltip({delay:300})}function c(a,c,n,k,x){switch(c){case 1:void 0!=n?(a.hover(b,f),a.click(function(){if(this.hasClass("seat-selected")){var d={row:a.attr("row"),col:a.attr("col")};h(d,k);this.removeClass("seat-selected");this.hover(b,f);n.seats_selected++}else 0<n.seats_selected&&(k.push({row:a.attr("row"),col:a.attr("col")}),n.seats_selected--,this.addClass("seat-selected"),
