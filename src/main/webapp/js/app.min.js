...
(function(){angular.module("cineweb","ngRoute uiGmapgoogle-maps cartModule PlaysModule tabmodule loginModule roomsModule registrationModule meModule adminDashboard adminUsers adminFilms adminPrices adminPlays adminRooms adminStats confirmModule resetModule buyModule pricesModule mapModule buyProcedureModule".split(" ")).config(["$routeProvider",function(a){a.when("/",{redirectTo:"/today"}).when("/home",{redirectTo:"/today"}).when("/today",{templateUrl:"../partials/today.html",controller:"PlaysController",
controllerAs:"ctrl"}).when("/today_mobile",{templateUrl:"../partials/today_mobile.html",controller:"PlaysController",controllerAs:"ctrl"}).when("/info",{templateUrl:"../partials/info.html"}).when("/cart_mobile",{templateUrl:"../partials/cart_mobile.html",controller:"CartController",controllerAs:"cc"}).when("/login_mobile",{templateUrl:"../partials/login_mobile.html",controller:"LoginController",controllerAs:"c"}).when("/registration",{templateUrl:"../partials/registration.html",controller:"RegistrationCtrl",
controllerAs:"ctrl"}).when("/password_recovery",{templateUrl:"../partials/password_recovery.html",controller:"LoginController",controllerAs:"c"}).when("/me",{templateUrl:"../partials/me.html",controller:"MeController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/login",{templateUrl:"../partials/login.html",controller:"LoginController",controllerAs:"c"}).when("/confirm",{templateUrl:"../partials/confirm.html",controller:"ConfirmController",controllerAs:"ctrl"}).when("/reset",{templateUrl:"../partials/reset.html",
controller:"ResetController",controllerAs:"ctrl"}).when("/admin",{templateUrl:"../partials/admin/dashboard.html",controller:"AdminDashboardController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/films",{templateUrl:"../partials/admin/films.html",controller:"AdminFilmsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/films/new",{templateUrl:"../partials/admin/new_film.html",controller:"AdminFilmsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/films/:fid",
{templateUrl:"../partials/admin/edit_film.html",controller:"AdminFilmsEditController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/plays",{templateUrl:"../partials/admin/plays.html",controller:"AdminPlaysController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/plays/new",{templateUrl:"../partials/admin/new_play.html",controller:"AdminNewPlaysController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/plays/:pid",{templateUrl:"../partials/admin/edit_play.html",
controller:"AdminPlaysEditController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/prices",{templateUrl:"../partials/admin/prices.html",controller:"AdminPricesController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/rooms",{templateUrl:"../partials/admin/rooms.html",controller:"AdminRoomsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/rooms/new_room",{templateUrl:"../partials/admin/new_room.html",controller:"AdminNewRoomController",
controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/rooms/edit_room/:rid",{templateUrl:"../partials/admin/edit_room.html",controller:"AdminEditRoomController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/stats",{templateUrl:"../partials/admin/stats.html",controller:"AdminStatsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/users",{templateUrl:"../partials/admin/users.html",controller:"AdminUsersController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/users/new",
{templateUrl:"../partials/admin/new_user.html",controller:"AdminUsersController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/users/:uid",{templateUrl:"../partials/admin/edit_user.html",controller:"AdminUsersEditController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/admin/users/bookings/:uid",{templateUrl:"../partials/admin/user_bookings.html",controller:"AdminUserBookingsController",controllerAs:"ctrl",resolve:{factory:checkRouting}}).when("/buy",{templateUrl:"../partials/buy_seats.html",
controller:"BuySeatController",controllerAs:"ctrl"}).when("/buy_start_error",{templateUrl:"../partials/buy_seats_error.html"}).when("/buy_last_step",{templateUrl:"../partials/buy_summary.html",controller:"BuySummaryController",controllerAs:"ctrl"}).when("/buy_complete",{templateUrl:"../partials/buy_complete.html",controller:"BuyCompleteController",controllerAs:"ctrl"}).when("/error",{templateUrl:"../partials/error.html"}).when("/popcorn",{templateUrl:"../partials/popcorn.html"}).otherwise({redirectTo:"/error"})}]).config(["uiGmapGoogleMapApiProvider",
function(a){a.configure({v:"3.17",libraries:"weather,geometry,visualization"})}]).directive("loading",function(){return{restrict:"E",templateUrl:"../partials/directives/loading.html",scope:{loading:"=loading"}}}).directive("onDropdownRepeat",function(){return function(a,c,e){a.$last&&a.$emit("dropdownRepeatEnd",c,e)}}).directive("onCollapsibleRepeat",function(){return function(a,c,e){a.$last&&a.$emit("collapsibleRepeatEnd",c,e)}}).directive("onSelectRepeat",function(){return function(a,c,e){a.$last&&
a.$emit("selectRepeatEnd",c,e)}}).directive("onTooltipRepeat",function(){return function(a,c,e){a.$last&&a.$emit("tooltipRepeatEnd",c,e)}}).run(["$rootScope","$location","$anchorScroll","$q","Prices","StorageService","Auth","CompletePlays","$sce","BuyProcedure",function(a,c,e,b,f,d,h,g,t,n){a.$on("$routeChangeStart",function(a,b){void 0!=c.search().c&&"/confirm"!=c.path()&&c.path("/confirm");void 0!=c.search().r&&"/reset"!=c.path()&&c.path("/reset")});a.$on("$routeChangeSuccess",function(){e()});
a.cloneObject=function(a){return JSON.parse(JSON.stringify(a))};a.trustSrcTrailerUrl=function(a){void 0!=a&&(a=a.replace("watch?v=","embed/"));return t.trustAsResourceUrl(a)};a.updateTotal=function(){for(var b=a.total=0;b<a.cart.length;b++)for(var g=0;g<a.tickets.length;g++){for(var f=0,d=0;d<a.cart[b].tickets.length;d++)a.cart[b].tickets[d].type==a.tickets[g].type&&(f+=a.cart[b].tickets[d].number);a.total+=a.tickets[g].price*f}};a.user={};a.isUserLogged=!1;a.isUserLoggedPromise=h.me();a.loginError=
"";a.afterLogin="normal";(function(){a.isUserLoggedPromise.then(function(b){a.isUserLogged=!0;a.user=b},function(b){a.isUserLogged=!1;a.user={}})})();a.loadPrices=function(){f.getList().then(function(b){a.tickets=b.data;a.updateTotal()})};a.tickets=[];a.loadPrices();a.loadPlaysByDate=function(){g.playsByDate().then(function(b){a.playsByDate=b},function(b){a.playsByDate=[];c.path("/error")})};a.loadPlaysByDate();a.cart=a.cart||[];a.total=a.total||0;(function(){a.cart=d.loadCart();null==a.cart&&(a.cart=
[]);n.proceed(a.cart).success(function(){}).error(function(b,g){a.cart=409==g?b:[]})})();a.$watch(function(){return a.cart},function(b){a.updateTotal();d.saveCart(b)},!0);a.cartLength=function(){return a.cart.length};a.buy={shared_obj:{},data_from_server:[],data_from_server_index:-1,data_to_server:{},complete_error:!0};a.buy.data_to_server.cart=[]}]);function checkRouting($rootScope,$location,Auth){if($rootScope.isUserLoggedPromise!=undefined){$rootScope.isUserLoggedPromise.then(function(data){if(data!=undefined){if(data.role!="admin"&&$location.path()!="/me"){$location.path("/error");}}},function(){$location.path("/login");});}else{Auth.me().then(function(){$rootScope.isUserLogged=true;$rootScope.user=data;if(data.role!="admin"&&$location.path()!="/me"){$location.path("/error");}},function(){$rootScope.isUserLogged=false;$rootScope.user={};$location.path("/login");});}}})();(function(){function a(a,b,f,d){$("#svg-theatre").empty();if(void 0==a||void 0==a[0])return 1;var e=a.length,h=a[0].length,l=55*h+100,r=55*e+110,v=680*l/650,y=15*v/680;$("#svg-theatre").attr({width:"100%",height:"100%"});var u=Snap("#svg-theatre");u.attr({viewBox:"0 0 "+v+" "+(165+r)});var m=Snap.fragment("<g class='stage'><polygon class='stage_floor' points='675,0 5,0 0,140 680,140'/><polygon class='stage_step' points='665,165 15,165 0,140 680,140'/><g class='stage_screen'><path class='stage_screen_display' d='M531,105c-0.9,2.5-2.5,5-5.6,5H154.9c-3.1,0-5-2.5-5.6-5L115,35h450L531,105z'/><path class='stage_screen_depth' d='M565,35c0-2.8-2.5-5-5.6-5H120.6c-3.1,0-5.6,2.2-5.6,5l0,0c0,2.8,2.5,5,5.6,5h438.8 C562.5,40,565,37.8,565,35L565,35z'/></g></g>"),
...
m.transform("s"+v/680+",1");q.attr({width:l,height:r,x:y,y:165});u.append(m);u.append(q);l=y;r=225;q=String.fromCharCode("A".charCodeAt()-1);for(m=v=0;m<e;m++){var p=A.clone();p.transform("t"+l+","+r);q="Z"==q?"A":String.fromCharCode(q.charCodeAt()+1);p.select("text").attr({text:q});u.append(p);l+=50;for(p=0;p<h;p++){var w=z.clone();w.transform("t"+l+","+r);w.attr({row:m.toString()});w.attr({col:p.toString()});c(w,a[m][p],b,f,d);0!=a[m][p]&&u.append(w);0==a[m][p]&&d&&u.append(w);l+=55}r+=55;l=y}l+=
50;for(m=0;m<h;m++)a=B.clone(),a.transform("t"+l+","+r),v++,a.select("text").attr({text:v}),u.append(a),l+=55;$(".tooltipped").tooltip({delay:300})}function c(a,c,n,k,x){switch(c){case 1:void 0!=n?(a.hover(b,f),a.click(function(){if(this.hasClass("seat-selected")){var d={row:a.attr("row"),col:a.attr("col")};h(d,k);this.removeClass("seat-selected");this.hover(b,f);n.seats_selected++}else 0<n.seats_selected&&(k.push({row:a.attr("row"),col:a.attr("col")}),n.seats_selected--,this.addClass("seat-selected"),
this.removeClass("seat-hover"),this.unhover(b,f))})):x&&(a.attr({cursor:"url(../img/cursors/hammer.png), default"}),d(a),a.click(function(){if(this.hasClass("seat-hidden")){var b={row:a.attr("row"),col:a.attr("col")};h(b,k);this.removeClass("seat-hidden");a.attr({cursor:"url(../img/cursors/hammer.png), default"})}else k.push({row:a.attr("row"),col:a.attr("col")}),this.addClass("seat-hidden"),a.attr({cursor:"url(../img/cursors/hotseat.png), default"})}));break;case 2:a.addClass("seat-unavailable");
break;case 3:a.addClass("seat-best");break;case 0:x&&(a.addClass("seat-hidden"),k.push({row:a.attr("row"),col:a.attr("col")}),a.attr({cursor:"url(../img/cursors/hotseat.png), default"}),d(a),a.click(function(){if(this.hasClass("seat-hidden")){var b={row:a.attr("row"),col:a.attr("col")};h(b,k);this.removeClass("seat-hidden");a.attr({cursor:"url(../img/cursors/hammer.png), default"})}else k.push({row:a.attr("row"),col:a.attr("col")}),this.addClass("seat-hidden"),a.attr({cursor:"url(../img/cursors/hotseat.png), default"})}))}a.addClass("tooltipped");
...
{email:a})},me:function(){var a=e.defer();c.get(f+"/me").success(function(b){a.resolve(b)}).error(function(b,d){a.reject(b)});return a.promise},my_bookings:function(){return c.get(d+"/my")},user_bookings:function(a){return c.get(d+"/"+a)},deleteTicket:function(a){return c["delete"](h+"/"+a)}}}])})();(function(){angular.module("adminDashboard",["constantsModule"]).controller("AdminDashboardController",["BASE","$http",function(a,c){var e=this;this.result="";this.interval=3;this.loadSampleData=function(){1<=e.interval?($(".data-loader").addClass("active"),this.result="CARICAMENTO...",c.post(a+"/load-example-data",e.interval).success(function(a){$(".data-loader").removeClass("active");e.result="CARICAMENTO...OK"}).error(function(a){$(".data-loader").removeClass("active");e.result="ERRORE"})):e.result=
"Inserire un valore positivo per l'intervallo tra le proiezioni"}}])})();(function(){angular.module("adminFilms",["filmsPlaysModule"]).controller("AdminFilmsEditController",["$routeParams","$location","Films",function(a,c,e){var b=this;this.currentFilm={};this.status="";this.error_message=!1;e.get({id:a.fid}).$promise.then(function(a){b.currentFilm=a},function(){c.path("/admin/films")});this.save=function(){e.update({id:b.currentFilm.fid},b.currentFilm).$promise.then(function(a){c.path("/admin/films")},function(a){b.error_message=!0;b.setStatus("Qualcosa \u00e8 andato storto, riprova");
...
"Films",function(a,c,e,b,f){var d=this;this.loading=!0;this.status="";this.error_message=!1;this.currentPlay={};this.currentSelectedPlay=this.currentSelectedFilm=this.currentSelectedDate=-1;this.shared_obj={};this.films=[];this.mapLoaded=!0;this.loadFilms=function(){f.query(function(a){d.films=a},function(){d.error_message=!0;d.setStatus("Errore durante il caricamento dei film")})};this.setCurrentPlay=function(a,f,c){d.mapLoaded=!1;d.currentPlay=d.playGenerator(a,f,c);d.currentSelectedDate=a;d.currentSelectedFilm=
f;d.currentSelectedPlay=c;b.getRoomStatus(d.currentPlay.pid).success(function(a){d.shared_obj.editable=!1;d.shared_obj.mapTheatre=a.seats;d.mapLoaded=!0}).error(function(a,b){d.shared_obj.editable=!1;d.shared_obj.mapTheatre=[];d.error_message=!0;d.setStatus("Errore durante il caricamento della mappa");$("html, body").animate({scrollTop:0},"fast");d.mapLoaded=!0})};this.deletePlay=function(){e["delete"]({id:d.currentPlay.pid}).$promise.then(function(){d.updatePlays();d.close_delete_modal();d.error_message=
!1;d.setStatus("Proiezione cancellata con successo");$("html, body").animate({scrollTop:0},"fast")},function(a){409==a.status?(d.error_message=!0,d.setStatus("Impossibile cancellare la proiezione, alcuni posti sono gi\u00e0 prenotati")):(d.error_message=!0,d.setStatus("Si \u00e8 verificato un errore, riprova"));d.close_delete_modal();$("html, body").animate({scrollTop:0},"fast")})};this.open_delete_modal=function(a,b,f){d.setCurrentPlay(a,b,f);$("#modal_deleteAgree").openModal()};this.close_delete_modal=
function(){$("#modal_deleteAgree").closeModal()};this.playGenerator=function(b,d,f){b=a.cloneObject(a.playsByDate[b].films[d]);b.pid=b.plays[f].pid;b.rid=b.plays[f].rid;b.free=b.plays[f].free;b.time=new Date(b.plays[f].time);delete b.date;delete b.plays;return b};this.updatePlays=function(){a.loadPlaysByDate()};this.setStatus=function(a){d.setStatusClass();d.status=a};this.setStatusClass=function(){d.error_message?($("#plays_message").removeClass("green-text white-text"),$("#plays_message").addClass("red-text")):
...
!0;f.shared_obj.selected_seats=[];f.shared_obj.mapTheatre=f.newRoom.seats};this.sendMap=function(){$(".room-loader").addClass("active");f.error_msg="";f.hiddenSeats=f.shared_obj.selected_seats;if(void 0!=f.hiddenSeats){for(var a=0;a<f.hiddenSeats.length;a++){var b=parseInt(f.hiddenSeats[a].row),e=parseInt(f.hiddenSeats[a].col);f.newRoom.seats[b][e]=0}void 0!=f.newRoom.seats&&void 0!=f.newRoom.seats[0]&&(f.newRoom.rows=f.newRoom.seats.length,f.newRoom.columns=f.newRoom.seats[0].length);f.newRoom.$save(function(a){$(".room-loader").removeClass("active");
c.path("/admin/rooms")},function(){$(".room-loader").removeClass("active");f.error_msg="Aggiunta della nuova sala fallita."})}else $(".room-loader").removeClass("active"),f.error_msg="Ricontrolla i dati inseriti."}}]).controller("AdminEditRoomController",["$rootScope","$routeParams","$location","Rooms","Theatre",function(a,c,e,b,f){var d=this;this.rid=c.rid;this.cols=this.rows=0;this.matrix=[[]];this.shared_obj={};this.hiddenSeats=[];this.error_msg="";this.mapLoaded=!1;this.getRoomMap=function(){d.mapLoaded=
!1;d.error_msg="";b.getRoomEditableByID(d.rid).success(function(a){d.matrix=a.seats;d.rows=d.matrix.length;d.cols=d.matrix[0].length;d.generateMap();d.mapLoaded=!0}).error(function(){d.error_msg="Non \u00e8 stato possibile scaricare la mappa dal server.";d.mapLoaded=!0})};this.generateMap=function(){d.shared_obj.editable=!0;d.shared_obj.selected_seats=[];d.shared_obj.mapTheatre=d.matrix};this.sendMap=function(){d.error_msg="";var a=d.matrix.length,c=d.matrix[0].length;$(".room-loader").addClass("active");
d.hiddenSeats=d.shared_obj.selected_seats;d.matrix=d.createMatrix(a,c);for(var f=0;f<d.hiddenSeats.length;f++){var n=parseInt(d.hiddenSeats[f].row),k=parseInt(d.hiddenSeats[f].col);d.matrix[n][k]=0}b.editRoom(d.rid,{rows:a,columns:c,seats:d.matrix}).success(function(){$(".room-loader").removeClass("active");e.path("/admin/rooms")}).error(function(a){$(".room-loader").removeClass("active");d.error_msg=409==a?"Si sta cercando di modificare posti gi\u00e0 prenotati.":"Modifica della sala fallita."})};
this.createMatrix=function(a,b){for(var d=[],f=0;f<a;f++){d[f]=[];for(var c=0;c<b;c++)d[f][c]=1}return d};d.getRoomMap()}]).controller("AdminRoomsController",["$rootScope","$location","Rooms",function(a,c,e){var b=this;this.currentRoom={};this.newRoom={};this.newRoom.seats=[b.newRoom.rows][b.newRoom.columns];this.rooms=[];this.currentSelected=-1;this.shared_obj={};this.delete_error=this.error="";this.mapLoaded=!0;this.loadRooms=function(){b.rooms=[];e.getRoomsOnly().success(function(a){b.rooms=a}).error(function(a){b.error=
"Sale non caricate."})};this.setCurrentRoom=function(a){b.mapLoaded=!1;b.currentRoom=b.rooms[a];b.currentSelected=a;e.getRoomTopByID(b.currentRoom.rid).success(function(a){b.shared_obj.editable=!1;b.shared_obj.mapTheatre=a.seats;b.mapLoaded=!0}).error(function(a){b.shared_obj.editable=!1;b.shared_obj.mapTheatre=[];b.mapLoaded=!0})};this.deleteRoom=function(){b.delete_error="";e["delete"](b.currentRoom.rid).success(function(){b.delete_error="";b.close_modal();b.loadRooms();b.shared_obj.editable=!1;
b.shared_obj.mapTheatre=[]}).error(function(a,d){b.delete_error=409==d?"Questa sala non pu\u00f2 essere cancellata. Alcuni posti sono prenotati.":"Errore, la sala non \u00e8 stata cancellata."})};this.open_modal=function(a){b.setCurrentRoom(a);$("#modal_room_delete").openModal()};this.close_modal=function(){b.delete_error="";$("#modal_room_delete").closeModal()};this.loadRooms()}])})();(function(){angular.module("adminStats",["statsModule"]).controller("AdminStatsController",["$location","Films","Stats",function(a,c,e){var b=this;this.error="";var f={labels:[],datasets:[{fillColor:"rgba(151,187,205,0.5)",strokeColor:"rgba(151,187,205,0.8)",highlightFill:"rgba(151,187,205,0.75)",highlightStroke:"rgba(151,187,205,1)",data:[]}]};this.topUsers=function(){e.topUsers().success(function(a){b.error="";for(var d in a)void 0!=a[d].spent&&(f.labels.push(a[d].firstName+" "+a[d].secondName),
f.datasets[0].data.push(a[d].spent));a=$("#topClients").get(0).getContext("2d");(new Chart(a)).Bar(f,{pointDot:!1})}).error(function(a){b.error="Il caricamento dei dati \u00e8 fallito."})};var d=[];this.filmsIncome=function(){e.grossingFilms().success(function(a){var c=["#E52323","#1C82AF","#E8C800","#464646","#1BB21B"];b.error="";a.sort(function(a,b){return b.grossing-a.grossing});for(var f in a)void 0!=a[f].grossing&&d.push({label:a[f].title,value:a[f].grossing,color:c[a.indexOf(a[f])%c.length]});
a=$("#filmsIncome").get(0).getContext("2d");(new Chart(a)).Doughnut(d,{animateScale:!0})}).error(function(a){b.error="Errore in parse dati film income"})};this.filmsIncome();this.topUsers()}])})();(function(){angular.module("adminUsers",["usersModule"]).controller("AdminUsersEditController",["$routeParams","$location","Users",function(a,c,e){var b=this;this.currentUser={};this.status="";this.error_message=!1;e.get({id:a.uid}).$promise.then(function(a){b.currentUser=a},function(){c.path("/admin/users")});this.save=function(){e.update({id:b.currentUser.uid},b.currentUser).$promise.then(function(a){c.path("/admin/users")},function(a){409==a.status?(b.error_message=!0,b.setStatus("Email gi\u00e0 in uso")):
...
["$routeParams","$scope","$location","$anchorScroll","Users","Auth",function(a,c,e,b,f,d){var h=this;this.bookings=[];this.uid=a.uid;this.currentTid=-1;this.status_msg="";this.intToChar=function(a){return String.fromCharCode("A".charCodeAt()+parseInt(a))};this.getBookings=function(){d.user_bookings(a.uid).success(function(a){h.bookings=a;for(a=0;a<h.bookings.length;a++){for(var b=h.bookings[a],d=0,c=0;c<b.tickets.length;c++)void 0!=b.tickets[c].price&&(d+=b.tickets[c].price);b.total=d}}).error(function(){})};
this.modifyTicketStatus=function(){h.status_msg="Un momento...";d.deleteTicket(h.currentTid).success(function(){h.status_msg="Modifica eseguita.";h.getBookings();b()}).error(function(){h.status_msg="Modifica fallita.";h.getBookings();b()});h.close_delete_modal()};this.open_modal_confirm=function(a,b){h.bookings[a].tickets[b].deleted||(h.currentTid=h.bookings[a].tickets[b].tid,$("#modal_delete_ticket_confirm").openModal())};this.close_delete_modal=function(){$("#modal_delete_ticket_confirm").closeModal()};
c.$on("collapsibleRepeatEnd",function(a,b,d){$(".collapsible").collapsible({accordion:!1})});h.getBookings()}]).controller("AdminUsersController",["$rootScope","$location","Users",function(a,c,e){var b=this;this.loading=!0;this.order="uid";this.reverse=!1;this.status="";this.error_message=!1;this.users=[];this.newUser=new e;this.newUser.enabled=!0;this.verifyPassword="";this.newUserRole=!1;this.currentUser={};this.tmpUser={};this.setOrder=function(a){this.order===a?this.reverse=!this.reverse:(this.reverse=
...
$("#password").focus()};this.setStatus=function(a){b.setStatusClass();b.status=a};this.setStatusClass=function(){b.error_message?($("#user_message").removeClass("green-text white-text"),$("#user_message").addClass("red-text")):($("#user_message").removeClass("red-text white-text"),$("#user_message").addClass("green-text"))};this.loadUsers()}])})();(function(){angular.module("buyModule",["usersModule","storageModule","constantsModule"]).controller("BuySeatController",["$rootScope","$location","$anchorScroll","$window","BuyProcedure","Rooms",function(a,c,e,b,f,d){function h(a){switch(a){case 1:g.error="Sembra che tu sia cercando di acquistare proiezioni o biglietti non pi\u00f9 disponibili. Per favore, ricontrolla il carrello.";break;case 2:g.error=""}}var g=this;this.go=!1;this.error="";this.mapLoaded=!1;a.buy.shared_obj.selected_seats=[];a.buy.shared_obj.film=
{};this.start_buy=function(){a.buy.shared_obj.film={};a.buy.shared_obj.selected_seats=[];a.buy.data_to_server=[];a.buy.data_to_server.cart=[];a.buy.data_from_server_index=-1;$(".buy-seats-loader").addClass("active");h(2);g.go=!1;a.isUserLogged?(a.afterLogin="normal",f.proceed(a.cart).success(function(){$(".buy-seats-loader").removeClass("active");h(2);a.buy.data_from_server=a.cloneObject(a.cart);g.go=!0;g.next_buy()}).error(function(b){a.cart=b;$(".buy-seats-loader").removeClass("active");g.go=!1;
h(1);c.path("/buy_start_error")})):($(".buy-seats-loader").removeClass("active"),a.afterLogin="buy",c.path("/login"))};this.next_buy=function(){a.buy.shared_obj.selected_seats=[];a.buy.data_from_server_index++;if(a.buy.data_from_server_index<a.buy.data_from_server.length){g.mapLoaded=!1;g.seats_msg="";a.buy.shared_obj.film=a.buy.data_from_server[a.buy.data_from_server_index];for(var b=a.buy.shared_obj.film.seats_selected=0;b<a.buy.shared_obj.film.tickets.length;b++)a.buy.shared_obj.film.seats_selected+=
a.buy.shared_obj.film.tickets[b].number;d.getRoomStatus(a.buy.shared_obj.film.pid).success(function(b){a.buy.shared_obj.selected_seats=[];a.buy.shared_obj.film.seats=b.seats;g.mapLoaded=!0}).error(function(){g.mapLoaded=!0;c.path("/error")});$(".buy-loader").removeClass("active");e()}else $(".buy-loader").removeClass("active"),e(),c.path("/buy_last_step")};this.save_seats=function(){0<a.buy.shared_obj.film.seats_selected?g.seats_msg="Devi ancora selezionare i posti rimanenti":($(".buy-loader").addClass("active"),
g.ff=a.cloneObject(a.buy.shared_obj.film),g.ff.selected_seats=a.cloneObject(a.buy.shared_obj.selected_seats),delete g.ff.seats,delete g.ff.seats_selected,a.buy.data_to_server.cart.push(g.ff),this.next_buy())};this.open_modal=function(){$("#modal_buy_cancel").openModal()};this.close_modal=function(){$("#modal_buy_cancel").closeModal()};this.cancel_procedure=function(){a.buy.shared_obj.film={};a.buy.shared_obj.selected_seats=[];a.buy.data_to_server.cart=[];a.buy.data_from_server=[];a.buy.data_from_server_index=
...
a.buy.data_to_server.cart[f].selected_seats[d],g=parseInt(h.row),h=parseInt(h.col);a.buy.data_to_server.cart[f].selected_seats[d]={row:g,col:h}}e.pay(b.cd,a.buy.data_to_server.cart).success(function(){$(".buy-loader").removeClass("active");a.buy.complete_error=!1;a.cart=[];a.buy.data_to_server={};c.path("/buy_complete")}).error(function(d,f){400==f?(b.error_msg=b.ERROR_CARD,$(".buy-loader").removeClass("active")):409==f&&(a.cart=[],a.cart=d,$(".buy-loader").removeClass("active"),a.buy.complete_error=
!0,c.path("/buy_complete"))})};this.open_modal=function(){$("#modal_buy_cancel").openModal()};this.close_modal=function(){$("#modal_buy_cancel").closeModal()};this.cancel_procedure=function(){a.buy.shared_obj.film={};a.buy.shared_obj.selected_seats=[];a.buy.data_to_server={};a.buy.data_from_server=[];a.buy.data_from_server_index=-1;this.close_modal();c.path("/today")};this.calcImportAndPrices=function(){var c=a.user.credit,d=a.buy.data_to_server.cart,e=-1;if(void 0!=d)for(var g=e=0;g<d.length;g++)for(var t=
0;t<a.tickets.length;t++){for(var n=0,k=0;k<d[g].tickets.length;k++)d[g].tickets[k].type==a.tickets[t].type&&(n+=d[g].tickets[k].number,d[g].tickets[k].price=a.tickets[t].price*d[g].tickets[k].number);e+=a.tickets[t].price*n}b.importToPay=void 0!=c?e>c?e-c:0:e};b.calcImportAndPrices()}]).controller("BuyCompleteController",["$rootScope",function(a){this.BUY_COMPLETE_SUCCESS="Il pagamento \u00e8 andato a buon fine. Grazie per aver acquistato sul nostro sito! A breve riceverai i biglietti direttamente nella tua casella di posta.";
...
function(a,b,c){$(".collapsible").collapsible({accordion:!1})});this.intToChar=function(a){return String.fromCharCode("A".charCodeAt()+parseInt(a))};e(this.loadUserBookings,1E3)}])})();(function(){angular.module("PlaysModule",["filmsPlaysModule"]).controller("PlaysController",["$rootScope","$scope","$location",function(a,c,e){var b=this;this.current={};this.show_trailer_for_current="Trailer";this.isNow=function(a){return!0};this.setCurrent=function(c,f){b.current=a.playsByDate[c].films[f];992>=$(window).width()?e.path("/today_mobile/").search("d",c).search("f",f):$("#modal").openModal()};this.closeWindow=function(){$("#modal").closeModal()};this.showTrailer=function(){this.show_trailer_for_current=
"Trailer"==this.show_trailer_for_current?"Locandina":"Trailer"};c.$on("dropdownRepeatEnd",function(a,b,c){$(".dropdown-button").dropdown()});c.$on("tooltipRepeatEnd",function(a,b,c){window.matchMedia("(min-width: 992px)").matches&&$(".tooltipped").tooltip({delay:50})});if(void 0!=e.search().d&&void 0!=e.search().f){c=e.search().d;var f=e.search().f;void 0!=a.playsByDate?b.current=a.playsByDate[c].films[f]:e.path("/today")}}])})();(function(){angular.module("registrationModule",["usersModule"]).controller("RegistrationCtrl",["Auth",function(a){var c=this;this.status="";this.user={};this.verifyPassword="";this.submit=function(e){$(".registration-loader").addClass("active");$("#registration_message").removeClass("red-text green-text");$("#registration_message").addClass("white-text");c.status="Un momento...";c.verifyPassword==c.user.password?a.registration(e.email,e.password,e.firstName,e.secondName).success(function(a){$("#registration_message").removeClass("red-text white-text");
