...
public class ManageData {
    ...
    final User a5 = new User(true, Role.ADMIN, "davidexxx@pippo.com", "c1n3w3b", "Samuel", "Giacomelli");
    ...
    public void loadExampleData() throws AnotherFilmScheduledException, UserNotFoundException, PlayGoneException {
